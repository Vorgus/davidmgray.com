<html>
	<head>
		...
		<title>
		David M Gray - Drafting & Design - Architectural
		</title>
		...
		<div id="MainBody">
			...
			<div class="GenericTextBlock">
				<span class="StandardText">
					I have experience with a variety of Floor Plans, Foundation Plans, Framing Plans, Sections, and Details in residential and commerical projects.
				</span>
			</div>			
			...
			<div class="GenericTextBlock">
				<span class="StandardText">
					Click a thumbnail below to see some samples of my Architectural drawings.
				</span>
			</div>
			...
			<div class="GenericBlock">
				<?php include("Elements/Includes/CADDArchitecturalGallery.php"); ?>
			</div>			
